...
public class Main {
    ...
    public static int[] heroHeals = {250, 230, 210, 260};
    ...
    public static void medic() {
        ...
        for (int i = 0; i < heroHeals.length; i++) {
            ...
            if (heroAttackType[i] == "Medic" && heroHeals[i] > 0){
                diadMedic=true;
            }
        }
        for (int i = 0; i < heroHeals.length; i++) {
            if (heroHeals[i] <= 100 && heroHeals[i] > 0 && diadMedic) {
                heroHeals[i] = heroHeals[i] + 75;
